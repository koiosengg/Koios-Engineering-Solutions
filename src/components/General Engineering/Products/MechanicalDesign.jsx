  ...
  return (
    <div className="s-product-list-set">
      <div className="s-product-list-set-heading">
        <p className="heading">MECHANICAL</p>
      ...
      <div className="s-product-list-set-container">
        ...
        <p className="subpage-desc">
          Utilizing CAD software and various analysis tools to engineer precise
          components and systems tailored to specific requirements. By
