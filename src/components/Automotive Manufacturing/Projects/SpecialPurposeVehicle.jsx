  ...
  return (
    <div className="s-product-list-set">
      <div className="s-product-list-set-heading">
        ...
        <h2>Manufacturing customized buggies, go-karts and many more!</h2>
      </div>
      <div className="s-product-list-set-container">
        ...
        <p className="subpage-desc">
          Manufacturing vehicles according to special requirements feature
          lightweight frames, and nimble handling, and often utilize internal
          combustion or electric engines. Our vehicles are engineered to excel
          in unique scenarios, offering thrill-seeking fun or efficient
          maneuverability in off-road or controlled environments.
        </p>
      </div>
    </div>
  );
