  ...
  return (
    <div className="s-product-list-set">
      <div className="s-product-list-set-heading">
        <p>Vehicle Component Manufacturing</p>
        <h2>
      ...
      <div className="s-product-list-set-container">
        ...
        <p className="subpage-desc">
          Manufacturing individual components that get assembled to vechicle sub
          systems. Our process involves precision machining, molding, and
          assembly techniques to ensure quality and performance. These
          components are then integrated into the vehicle assembly process to
          create a functional and reliable automobile.
        </p>
      </div>
    </div>
  );
...
export default VehicleComponentManufacturing;
