  ...
  return (
    <div className="s-product-list-set">
      <div className="s-product-list-set-heading">
        <p>Vehicle Chassis Manufacturing</p>
        <h2>
          Manufacturing support and services for the development of customized
          vehicle chassis.
        </h2>
      </div>
      <div className="s-product-list-set-container">
        ...
        <p className="subpage-desc">
          Crafting the structural framework that supports the vehicle's body,
          engine, suspension, and other components. It's built using sturdy
          materials like steel or aluminum, providing rigidity and impact
          resistance. Our chassis design optimizes stability, handling, and
          safety, forming the foundation for the entire vehicle.
        </p>
      </div>
    </div>
  );
...
export default VehicleChassisManufacturing;
