  ...
  return (
    <div className="s-product-list-set">
      <div className="s-product-list-set-heading">
        <p>Custom Vehicle Manufacturing</p>
        <h2>Manufacturing of custom vehicles to cater to your needs.</h2>
      </div>
      <div className="s-product-list-set-container">
        ...
        <p className="subpage-desc">
          Creating personalized vehicles to match individual preferences and
          needs. This process encompasses bespoke design, fabrication, and
          integration of unique features, often using modular platforms and
          specialized components. The result is a tailor-made vehicle that
          reflects the owner's vision and showcases innovative engineering.
        </p>
      </div>
    </div>
  );
...
export default CustomVehicleManufacturing;
