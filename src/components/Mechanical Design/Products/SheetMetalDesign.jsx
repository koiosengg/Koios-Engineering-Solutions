  ...
  return (
    <div className="s-product-list-set">
      <div className="s-product-list-set-heading">
        <p>Sheet Metal Design</p>
        <h2>
          Designing sheet metal components, press tools and related mechanisms.
        </h2>
      </div>
      <div className="s-product-list-set-container">
        ...
        <p className="subpage-desc">
          Mechanical sheet metal design utilizes CAD software for efficient
          component development from thin metal sheets, optimizing cost, ease of
          manufacturing, and structural integrity. Our designs serve various
          applications including enclosures, brackets, and panels for
